const CACHE_NAME = "florist-studio-v4.5";
const APP_SHELL = [
  "./", "./index.html", "./manifest.json",
  "./assets/css/style.css?v=4.1.0", "./assets/css/responsive-v4.css?v=4.5.0",
  ...
  "./assets/js/cloud-sync.js?v=4.2.0", "./assets/js/stability-v4.2.js?v=4.5.0",
